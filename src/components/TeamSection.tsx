...
const team = [
  ...
  },
  {
    ...
    desc: "Создаёт визуальную концепцию аквариума и отвечает за его внешний вид. Работает с композицией, светом и объёмом, выстраивая гармоничный подводный пейзаж.",
  },
  {
    img: teamYulia,
    name: "Юлия",
